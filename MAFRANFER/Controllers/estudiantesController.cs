...
namespace MAFRANFER.Controllers
{
    ...
    public class estudiantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "estudiante_id,nro_documento,tipo_documento,nombre,apellido,direccion,celular,telefono,email,sexo,fecha_nacimiento")] estudiante estudiante)
        {
